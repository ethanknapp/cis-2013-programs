...
{
    intMin = parseInt(prompt("I'm sorry, but your lowest nuimber choice is invalid. \n" + "Please choose the lowest number (but no lower than 0) in your guessing range: "));
}
...
*/
intMax = parseInt(prompt("Choose the highest number (but no lower than a 0) in your guessing range"));

while (isNaN(intMax) || (intMax) > (intMin + 2));
{
    intMax = parseInt(prompt("I'm sorry, but your highest number is invalid. \n" + "Please choose the highest number (at least two higher than your minimum) in your guessing range"));
}
...
while (isNaN(intGuess || intGuess < intMin || intGuess > intMax))
       {
        intGuess = parseInt(prompt("I'm sorry, but you guess is not within the valid range."));
       }
